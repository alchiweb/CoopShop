...
namespace CoopShop.DataShop.Entities
{
    ...
    [ConnectionKey("DataShop"), TableName("Territories"), DisplayName("Territories"), InstanceName("Territory"), TwoLevelCached]
    [ReadPermission(PermissionKeys.General)]
    [ModifyPermission(PermissionKeys.General)]
    [LookupScript("DataShop.Territory")]
    public sealed class TerritoryRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
            {
                LocalTextPrefix = "DataShop.Territory";
            }
        }
    }
}