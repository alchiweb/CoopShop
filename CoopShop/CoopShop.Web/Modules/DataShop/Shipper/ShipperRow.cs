...
namespace CoopShop.DataShop.Entities
{
    ...
    [ConnectionKey("DataShop"), TableName("Shippers"), DisplayName("Shippers"), InstanceName("Shipper"), TwoLevelCached]
    [ReadPermission(PermissionKeys.General)]
    [ModifyPermission(PermissionKeys.General)]
    [LookupScript("DataShop.Shipper")]
    public sealed class ShipperRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
            {
                LocalTextPrefix = "DataShop.Shipper";
            }
        }
    }
}