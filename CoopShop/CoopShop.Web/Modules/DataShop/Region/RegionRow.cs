...
namespace CoopShop.DataShop.Entities
{
    ...
    [ConnectionKey("DataShop"), TableName("Region"), DisplayName("Region"), InstanceName("Region"), TwoLevelCached]
    [ReadPermission(PermissionKeys.General)]
    [ModifyPermission(PermissionKeys.General)]
    [LookupScript("DataShop.Region")]
    public sealed class RegionRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
            {
                LocalTextPrefix = "DataShop.Region";
            }
        }
    }
}