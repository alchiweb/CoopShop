...
namespace CoopShop.DataShop.Entities
{
    ...
    [ConnectionKey("DataShop"), TableName("Employees"), DisplayName("Employees"), InstanceName("Employee"), TwoLevelCached]
    [ReadPermission(PermissionKeys.General)]
    [ModifyPermission(PermissionKeys.General)]
    [LookupScript("DataShop.Employee")]
    public sealed class EmployeeRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
            {
                LocalTextPrefix = "DataShop.Employee";
            }
        }
    }
}