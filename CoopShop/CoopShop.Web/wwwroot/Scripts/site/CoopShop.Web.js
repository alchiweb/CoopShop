...
(function (CoopShop) {
    ...
    (function (DataShop) {
        ...
        [['InternalRef', function () { return Serenity.StringEditor; }], ['ProductID', function () { return DataShop.ProductEditor; }], ['UnitPrice', function () { return Serenity.DecimalEditor; }], ['Quantity', function () { return Serenity.DecimalEditor; }], ['QuantitySymbol', function () { return Serenity.EnumEditor; }], ['QuantityPerUnitPrice', function () { return Serenity.DecimalEditor; }], ['Discount', function () { return Serenity.DecimalEditor; }], ['UnitsInStock', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(OrderDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(DataShop = CoopShop.DataShop || (CoopShop.DataShop = {}));
})(CoopShop || (CoopShop = {}));
var CoopShop;
(function (CoopShop) {
