...
(function (CoopShop) {
    ...
    (function (DataShop) {
        ...
        [['IsCoop', function () { return Serenity.BooleanEditor; }], ['CustomerID', function () { return Serenity.StringEditor; }], ['ContactTitle', function () { return Serenity.StringEditor; }], ['ContactName', function () { return Serenity.StringEditor; }], ['CompanyName', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.EmailEditor; }], ['SendBulletin', function () { return Serenity.BooleanEditor; }], ['Address', function () { return Serenity.StringEditor; }], ['PostalCode', function () { return Serenity.StringEditor; }], ['City', function () { return Serenity.LookupEditor; }], ['Country', function () { return Serenity.LookupEditor; }], ['Phone', function () { return Serenity.StringEditor; }], ['Fax', function () { return Serenity.StringEditor; }], ['NoteList', function () { return DataShop.NotesEditor; }]].forEach(function (x) { return Object.defineProperty(CustomerForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(DataShop = CoopShop.DataShop || (CoopShop.DataShop = {}));
})(CoopShop || (CoopShop = {}));
var CoopShop;
(function (CoopShop) {
